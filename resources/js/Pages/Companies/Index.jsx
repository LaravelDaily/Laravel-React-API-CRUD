    ...
    renderCompanies() {
        return this.state.companies.map(company => <tr key={company.id}>
            ...
            <td className="px-6 py-4 text-sm leading-5 text-gray-900 whitespace-no-wrap">
                <NavLink to={`/companies/edit/${company.id}`} className="mr-2 bg-gray-800 hover:bg-gray-700 rounded-md text-white px-4 py-2 font-semibold ease-in-out duration-150">Edit</NavLink>
